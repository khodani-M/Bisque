	...
	\section{Specific Requirements}
		\paragraph\indent
			...
				...
				The application must be able to run on different operating environments or platforms i.e. the application must be able to run on OS and android.
				The application must be able to run on different hardware devices, including smartphones, smartwatches, laptops and tablets.
